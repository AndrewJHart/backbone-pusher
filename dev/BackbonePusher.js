/* Authored by Andrew J. Hart and licensed under MIT. This file was generated by Coffee-Script */
var BackbonePusher, defaults,
...
BackbonePusher = (function(window, _, Backbone, Pusher) {
    function BackbonePusher() {
    ...
    _.extend(BackbonePusher.prototype, Backbone.Events);

    BackbonePusher.prototype.filters = null;

    BackbonePusher.prototype.settings = null;

    BackbonePusher.prototype.states = {
        last: null,
        current: null
    };

    BackbonePusher.prototype.logging = false;

    BackbonePusher.prototype.live = function(options) {
        var opts;
        opts = options || {};
        this.settings = _.defaults(opts, defaults);
    ...
    BackbonePusher.prototype.logEventsStates = function() {
        var _this = this;
        console.log('BackbonePusher#setup triggered');
        if (this.pusher && this.logging) {
            this.pusher.connection.bind('state_change', function(state) {
                console.log("BackbonePusher.pusher state: " + state.current);
                _this.states = state;
                return _this;
            });
        }
    ...
    BackbonePusher.prototype.getState = function() {
        var _ref;
        console.log("Current Pusher State: " + ((_ref = this.pusher) != null ? _ref.connection.state : void 0));
        return this;
    };

    BackbonePusher.prototype.socketStatus = function() {
    ...
    BackbonePusher.prototype.initPusher = function() {
        if (!this.pusher) {
    ...
    BackbonePusher.prototype.initChannel = function() {
        var _this = this;
        if (this.pusher != null) {
            ...
            setTimeout(function() {
                console.log('BackbonePusher#initChannel Error on subscribe retrying');
    ...
    BackbonePusher.prototype.connect = function() {
        var _this = this;
        console.log('BackbonePusher#connect triggered');
        this.initPusher();
        this.initChannel();
        if (this.logging) {
    ...
    BackbonePusher.prototype.filters = function(filters) {
        if (!filters) {
            return this.filters;
        }
    ...
    BackbonePusher.prototype.liveUpdate = function(data) {
    ...
    BackbonePusher.prototype.liveAdd = function(data) {
    ...
    BackbonePusher.prototype.liveRemove = function(data) {
        var model;
